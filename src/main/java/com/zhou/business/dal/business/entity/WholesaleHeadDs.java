...
public class WholesaleHeadDs {
    ...
    public String toString() {
        ...
        sb.append(", shdate=").append(shdate);
    ...
    public boolean equals(Object that) {
        ...
        return (this.getWholesaleid() == null ? other.getWholesaleid() == null : this.getWholesaleid().equals(other.getWholesaleid()))
            ...
            && (this.getShdate() == null ? other.getShdate() == null : this.getShdate().equals(other.getShdate()))
            && (this.getShflag() == null ? other.getShflag() == null : this.getShflag().equals(other.getShflag()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getShdate() == null) ? 0 : getShdate().hashCode());
        result = prime * result + ((getShflag() == null) ? 0 : getShflag().hashCode());
        return result;
    }
}